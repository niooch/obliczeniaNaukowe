...
\end{table}
\subsection{Wnioski}
Widać, że taki rekurencyjny proces jest bardzo wrażliwy na zaburzenia, ponieważ nawet niewielka zmiana wartości w $p_{10}$ powoduje ogromne różnice w dalszych iteracjach. 
