...
\]
na wykładzie oznaczaliśmy przez $\epsilon$ najmniejszą możliwą liczbę w danej arytmetyce, taką że $fl(1 + \epsilon) > 1$. W związku z tym $macheps$ jest podwojoną miarą precyzji danej arytmetyki zmiennoprzecinkowej.
